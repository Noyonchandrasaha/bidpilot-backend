...
RLS_SQL = [
    ...
    "CREATE POLICY rls_users_select ON users FOR SELECT USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR id::text = current_setting('app.current_user_id', true));",
    "DROP POLICY IF EXISTS rls_users_modify ON users;",
    "CREATE POLICY rls_users_modify ON users FOR UPDATE USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR id::text = current_setting('app.current_user_id', true)) WITH CHECK (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR id::text = current_setting('app.current_user_id', true));",
    "DROP POLICY IF EXISTS rls_user_profiles ON user_profiles;",
    "CREATE POLICY rls_user_profiles ON user_profiles FOR ALL USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR user_id::text = current_setting('app.current_user_id', true)) WITH CHECK (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR user_id::text = current_setting('app.current_user_id', true));",
    ...
    "CREATE POLICY rls_customer_segments ON customer_segments FOR ALL USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff')) WITH CHECK (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff'));",
    "DROP POLICY IF EXISTS rls_customers ON customers;",
    "CREATE POLICY rls_customers ON customers FOR ALL USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR created_by_id::text = current_setting('app.current_user_id', true) OR updated_by_id::text = current_setting('app.current_user_id', true)) WITH CHECK (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR created_by_id::text = current_setting('app.current_user_id', true) OR updated_by_id::text = current_setting('app.current_user_id', true));",
    "DROP POLICY IF EXISTS rls_customer_transactions ON customer_transactions;",
    "CREATE POLICY rls_customer_transactions ON customer_transactions FOR ALL USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR created_by_id::text = current_setting('app.current_user_id', true)) WITH CHECK (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR created_by_id::text = current_setting('app.current_user_id', true));",
    ...
    "CREATE POLICY rls_audit_logs ON audit_logs FOR SELECT USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR actor_id::text = current_setting('app.current_user_id', true));",
    "DROP POLICY IF EXISTS rls_file_uploads ON file_uploads;",
    "CREATE POLICY rls_file_uploads ON file_uploads FOR ALL USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR uploaded_by_id::text = current_setting('app.current_user_id', true)) WITH CHECK (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR uploaded_by_id::text = current_setting('app.current_user_id', true));",
    "DROP POLICY IF EXISTS rls_settings ON settings;",
    "CREATE POLICY rls_settings ON settings FOR ALL USING (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR user_id::text = current_setting('app.current_user_id', true) OR scope::text = 'SYSTEM') WITH CHECK (current_setting('app.rls_bypass', true) = 'on' OR current_setting('app.current_role', true) IN ('admin','staff') OR user_id::text = current_setting('app.current_user_id', true) OR scope::text = 'SYSTEM');",
]
